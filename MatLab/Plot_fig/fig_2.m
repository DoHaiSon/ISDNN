...
semilogy(epoch_unstr_4l, NMSE_unstr_4l, '-o', 'LineWidth', 1.5, 'Color', "#FF0000", 'MarkerSize', 7, 'MarkerFaceColor', "#FFFF00", 'MarkerIndices', 1:5:length(epoch_unstr_4l));
hold on;
semilogy(epoch_str_4l, NMSE_str_4l, '-o', 'LineWidth', 1.5, 'Color', "#7E2F8E", 'MarkerSize', 5, 'MarkerFaceColor', "#FFFF00", 'MarkerIndices', 1:5:length(epoch_str_4l));
semilogy(epoch_unstr_5l, NMSE_unstr_5l, '--^', 'LineWidth', 1.5, 'Color', "#0072BD", 'MarkerSize', 7, 'MarkerFaceColor', "#FFFF00", 'MarkerIndices', 1:5:length(epoch_unstr_5l));
semilogy(epoch_str_5l, NMSE_str_5l, '--^', 'LineWidth', 1.5, 'Color', "#77AC30", 'MarkerSize', 5, 'MarkerFaceColor', "#FFFF00", 'MarkerIndices', 1:5:length(epoch_str_5l));
